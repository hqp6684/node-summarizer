import { TextSummarizer } from './text-summarizer/text-summarizer';


console.log('Running ...')

let tool = new TextSummarizer();
...
const content = `
    ...
    I was also tired, cranky and missing my kids – so my frame of mind wasn’t the most positive.
